...
<details class="research-project">
  ...
  <div class="project-abstract">
    <p>
This paper estimates the economic consequences of unexpected spousal death in Europe. Conventional analyses treat bereavement as the onset of treatment, although illness, caregiving, and financial preparation may affect household outcomes before death, thereby conflating anticipatory adjustment with the consequences of spousal loss. Using longitudinal data from the Survey of Health, Ageing and Retirement in Europe (SHARE) for 2004-2022 and information from end-of-life interviews, I identify unexpected deaths, for which the scope for prolonged anticipatory adjustment is limited. I thus combine this classification with propensity-score matching and staggered difference-in-differences models to estimate the effects of unexpected spousal death on survivors’ economic outcomes. The estimates show a large and persistent deterioration in economic security in later life. Equivalised household income falls sharply while expenditure rises, producing a sustained decline in the income-to-expenditure ratio and increased financial distress. Net wealth declines more gradually, driven primarily by reductions in real assets and long-term savings, while net financial assets remain broadly stable. These effects are particularly pronounced among widows, who experience larger income and wealth losses and clearer increases in financial distress than widowers. Institutional heterogeneity is consistent with survivor pensions providing protection: income losses and increases in financial distress are smaller in countries with higher survivor-pension replacement rates, whereas labour-market re-entry is not a systematic adjustment response. Information on inheritance and heirs further indicates that wealth losses reflect not only financial hardship but also transfers outside the surviving household and post-bereavement asset and housing adjustments.
    </p>
  </div>
</details>
