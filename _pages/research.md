...
<details class="research-project">
  ...
  <div class="project-abstract">
    <p>
This paper estimates the economic consequences of unexpected spousal death in Europe. Using longitudinal data from the Survey of Health, Ageing and Retirement in Europe (SHARE), covering 2004-2022, I exploit end-of-life interviews to identify deaths with limited scope for anticipatory adjustment and estimate causal effects using propensity score matching combined with staggered difference-in-differences and event study models. The findings reveal that unexpected spousal death causes a large and persistent deterioration in late-life economic security across flows, balance sheets, and subjective financial distress. Equivalised income falls sharply after bereavement, while expenditure rises, generating a sustained deterioration in the income-to-expenditure ratio and an increase in financial distress. Wealth responses are slower but substantial. Equivalised net wealth declines over time, driven by real-asset contractions and drawdowns of long-term savings, whereas net financial assets remain broadly stable. These effects are strongly gendered, with widows experiencing larger income and wealth losses and clearer increases in financial distress. The extent to which bereavement translates into hardship depends critically on the institutional context: income losses and distress responses are attenuated in countries with more generous survivor-pension replacement rates, while labour-market re-entry is not a systematic adjustment margin in this older population. The paper highlights survivor protection as a key form of late-life insurance and show that post-bereavement wealth losses reflect not only hardship, but also asset transfers and portfolio reorganisation.
    </p>
  </div>
</details>
